...
class TelaLacos extends JFrame {
    ...
    public TelaLacos() {
        ...
        // Ações
        btnExemplo.addActionListener(e -> { 
            new TelaExemploLacos().setVisible(true);
          });
        
        btnDesafioWhile.addActionListener (e -> {
            new TelaDesafioWhile().setVisible(true);
          });
        
        btnDesafioFor.addActionListener(e -> {
            new TelaDesafioFor().setVisible(true);
    });
