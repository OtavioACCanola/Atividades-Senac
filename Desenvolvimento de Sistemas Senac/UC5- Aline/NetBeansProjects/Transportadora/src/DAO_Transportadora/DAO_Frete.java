...
import model_Transportadora.Frete; // Importa a classe Frete do pacote model
...
public class DAO_Frete { // Classe responsável pelo gerenciamento dos objetos Frete em memória
    ...
    private final List<Frete> lista_Frete = new ArrayList<>();
    
    // Método para salvar (adicionar) um frete na lista (Tipo um INSERT do Banco de Dados)
    public void salvar_Frete(Frete frete){
    ...
    public List<Frete> listar_Frete(){
    ...
    */
    ...
    public List<Frete> findByPeriod(LocalDate ini, LocalDate fim){
