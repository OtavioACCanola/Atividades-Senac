...
public class FreteController {
    ...
    private final Strategy_CalculadoraFrete calculadoraFrete;
    
    public FreteController(DAO_Frete frete, DAO_Veiculo veiculo, DAO_Rota rota, Strategy_CalculadoraFrete calculadoraFrete){
        this.daofrete = frete;
        this.daoRota = rota;
    ...
    public void registrarFrete(UUID transportadoraId, UUID motoristaId, UUID veiculoId, UUID rotaId){
        ...
        daofrete.salvar_Frete(new Frete(transportadoraId, motoristaId, veiculoId, rotaId, LocalDateTime.now(), valor));
    }
}
