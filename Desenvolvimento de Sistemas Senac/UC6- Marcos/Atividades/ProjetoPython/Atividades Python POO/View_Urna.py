...
TelaSUrna = uic.loadUi("TelaSenhaUrna.ui")
TelaVot = uic.loadUi("TelaVotacao.ui")
TelaSairUrna = uic.loadUi("TelaSenhaSairUrna.ui")
...
def PerguntaVotoNovo():
    resposta = QMessageBox.question(TelaVot, "Pergunsta", "Deseja Votar Novamente?", QMessageBox.Yes | QMessageBox.No)
...
def apuracao():
    ...
    elif porcentagemCand1 == porcentagemCand2 and porcentagemCand2 == porcentagemCand1:
        mensagem = [f"O candidato {candidato1.nome} e a candidata {candidato2.nome} estão no 2º Turno!"]
        TelaVot.LblNumeroCandidatos.addItems(mensagem)
    
    elif porcentagemCand1 == porcentagemCand3 and porcentagemCand3 == porcentagemCand1:
        mensagem = [f"O candidato {candidato1.nome} e o candidato {candidato3.nome} estão no 2º Turno!"]
        TelaVot.LblNumeroCandidatos.addItems(mensagem)
    
    elif porcentagemCand2 == porcentagemCand3 and porcentagemCand3 == porcentagemCand2:
        mensagem = [f"A candidata {candidato2.nome} e o candidato {candidato3.nome} estão no 2º Turno!"]
        TelaVot.LblNumeroCandidatos.addItems(mensagem)

    else:
        mensagem = [f"Os Votos Brancos e Nulos superaram os Votos Válidos. Nenhum Ganhador foi Definido!"]
        TelaVot.LblNumeroCandidatos.addItems(mensagem)
